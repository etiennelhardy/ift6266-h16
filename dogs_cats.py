# -*- coding: utf-8 -*-
"""
Created on Mon Feb 01 14:59:33 2016
...
float32_stream = Cast(flattened_stream, dtype='float32', which_sources=('image_features',))
...
main_loop = MainLoop(data_stream=float32_stream, algorithm=algorithm,
